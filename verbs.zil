...
>">
		 ...
		 <COND (<EQUAL? .WRD ,W?RESTART>
			...
			<QUIT>)
		       (<EQUAL? .WRD ,W?HINT ,W?HINTS ,W?CLUE>
			<V-HINT>
			<AGAIN>)>>>
...
<ROUTINE PRE-FILL ("AUX" TX)
	 <COND (<NOT ,PRSI>
		<SET TX <GETPT ,HERE ,P?GLOBAL>>
	       <COND (<AND .TX <ZMEMQ ;B ,GLOBAL-WATER .TX 
				      <- </ <PTSIZE .TX> 2> 1>>>
...
;<ROUTINE PRE-FILL ("AUX" TX) 
	 <COND (<NOT ,PRSI>
		<COND (<AND <SET TX <GETPT ,HERE ,P?GLOBAL>>
			    <ZMEMQ ;B ,GLOBAL-WATER .TX <- <PTSIZE .TX> 1>>>
		      ...
		      (<EQUAL? .PTS ,CEXIT>
		       <COND (<VALUE <GETB .PT ,CEXITFLAG>>
			     ...
			     (T
			      ...
			      <RFATAL>)>)
		      (<EQUAL? .PTS ,DEXIT>
		       <COND (<FSET? <SET OBJ <GET ;B .PT ,DEXITOBJ>> ,OPENBIT>
			      <GOTO <GET ;B .PT ,REXIT>>)
