...
<OBJECT TREE
	(LOC LOCAL-GLOBALS)
	(SYNONYM TREE BRANCH)
	(ADJECTIVE LARGE STORM-TOSSED ;"-TOSSED")
	(DESC "tree")
...
the trees.")
      ...
      (NORTH TO PATH)
      (SOUTH SORRY "The windows are all boarded.")
      (FLAGS RLANDBIT ONBIT SACREDBIT)
...
and all the windows are boarded.")
      ...
      (NW TO WEST-OF-HOUSE)
      (SOUTH TO FOREST-3)
      (NORTH SORRY "The windows are all boarded.")
      (FLAGS RLANDBIT ONBIT SACREDBIT)
      (GLOBAL BOARDED-WINDOW BOARD WHITE-HOUSE FOREST)>
...
there appears to be sunlight.")
      (DESC "Forest")
      (UP SORRY "There is no tree here suitable for climbing.")
      (NORTH TO GRATING-CLEARING)
      (EAST TO PATH)
      (SOUTH TO FOREST-3)
      (WEST SORRY "You would need a machete to go further west.")
      (ACTION FOREST-ROOM)
      (FLAGS RLANDBIT ONBIT SACREDBIT)
...
<ROOM FOREST-2
      ...
      (DESC "Forest")
      (UP SORRY "There is no tree here suitable for climbing.")
      (NORTH SORRY "The forest becomes impenetrable to the north.")
      (EAST TO MOUNTAINS)
      (SOUTH TO CLEARING)
      (WEST TO PATH)
      (ACTION FOREST-ROOM)
...
<ROOM MOUNTAINS
      ...
      (DESC "Forest")
      (UP SORRY "The mountains are impassable.")
      (NORTH TO FOREST-2)
      (EAST SORRY "The mountains are impassable.")
      (SOUTH TO FOREST-2)
      (WEST TO FOREST-2)
      (FLAGS RLANDBIT ONBIT SACREDBIT)
...
<ROOM FOREST-3
      ...
      (UP SORRY "There is no tree here suitable for climbing.")
      (NORTH TO CLEARING)
      (EAST SORRY "The rank undergrowth prevents eastward movement.")
      (SOUTH SORRY "Storm-tossed trees block your way.")
      (WEST TO FOREST-1)
...
<ROOM UP-A-TREE
      ...
      (DESC "Up a Tree")
      (DOWN TO PATH)
      (UP SORRY "You cannot climb any higher.")
      (ACTION TREE-ROOM)
      (FLAGS RLANDBIT ONBIT SACREDBIT)
...
to the east.")
      ...
      (NORTH TO CELLAR)
      (EAST TO GALLERY)
      (DOWN SORRY "The chasm probably leads straight to the infernal regions.")
      (FLAGS RLANDBIT)
      (GLOBAL CHASM)
...
<ROOM RESERVOIR
      ...
      (UP TO IN-STREAM)
      (WEST TO IN-STREAM)
      (DOWN SORRY "The dam blocks your way.")
...
walls. There is a narrow beach to land on.")
      (DESC "Stream")
      (UP SORRY "The channel is too narrow.")
      (WEST SORRY "The channel is too narrow.")
      (LAND TO STREAM-VIEW)
      (DOWN TO RESERVOIR)
      (EAST TO RESERVOIR)
      (FLAGS NONLANDBIT)
...
the south. The earth is particularly damp here.")
      ...
      (SOUTH SORRY "It is too narrow for most insects.")
      (FLAGS RLANDBIT)
      (GLOBAL CRACK)>
...
on the south side of the chasm, where a crack opens into a passage.")
      ...
      (UP TO EW-PASSAGE)
      (SOUTH TO NS-PASSAGE)
      (DOWN SORRY "Are you out of your mind?")
      (FLAGS RLANDBIT)
...
<ROOM TORCH-ROOM
      (LOC ROOMS)
      (DESC "Torch Room")
      (UP SORRY "You cannot reach the rope.")
...
flows quietly here. There is a landing on the west shore.")
      (DESC "Frigid River")
      (UP SORRY "You cannot go upstream due to strong currents.")
      (WEST TO DAM-BASE)
      (LAND TO DAM-BASE)
      (DOWN TO RIVER-2)
      (EAST SORRY "The White Cliffs prevent your landing here.")
...
landing on the west.")
      ...
      (UP SORRY "You cannot go upstream due to strong currents.")
      (DOWN TO RIVER-3)
      (LAND SORRY "There is no safe landing spot here.")
      (EAST SORRY "The White Cliffs prevent your landing here.")
      (WEST SORRY "Just in time you steer away from the rocks.")
...
area of beach can also be seen below the cliffs on the west shore.")
      ...
      (UP SORRY "You cannot go upstream due to strong currents.")
      (DOWN TO RIVER-5)
      (LAND SORRY "You can land either to the east or the west.")
...
shaft is a metal framework to which a heavy iron chain is attached.")
      (DESC "Shaft Room")
      (DOWN SORRY "You wouldn't fit and would die if you could.")
      (WEST TO BAT-ROOM)
